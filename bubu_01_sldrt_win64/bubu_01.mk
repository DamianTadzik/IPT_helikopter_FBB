...
MODEL                := bubu_01
MODULES              := rt_matrx.c rt_printf.c bubu_01_data.c bubu_01_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := bubu_01.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := bubu_01_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/ident_sr_11_30;D:/ident_sr_11_30/bubu_01_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
